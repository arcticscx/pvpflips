    ...
    <div class="deposit-robux">
        ...
        <div class="robux-info">
            <div class="info-deposit">
                Using Growduel for saving (storing in order to avoid bans) or reselling DLs is strictly prohibited. Doing so will result in your balance getting removed without any warnings.
            </div>
        </div>
    </div>
</template>
