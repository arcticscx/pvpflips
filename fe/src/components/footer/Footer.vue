    ...
    <footer id="footer">
        <div class="footer-inner">
            <div class="inner-info">
                ...
                <div class="info-text"> Growduel.live is the leading crypto gaming experience! <br> Play crash,
                    roulette, blackjack, upgrader, mines and more.
                    <div class="text-copy">Copyright © 2024 Growduel.live. All rights reserved.</div>
