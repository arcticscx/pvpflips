...
export default {
    ...
    computed: {
        ...
        chatGetGameLink() {
            ...
            if (
                this.message.message.replace(/&#x2F;/g, '/').match(/(Growduel\.com\/battles\/[0-9a-fA-F]{24})/) !== null ||
                this.message.message.replace(/&#x2F;/g, '/').match(/(Growduel\.com\/battles\/[0-9a-fA-F]{24})/) !== null ||
                this.message.message.replace(/&#x2F;/g, '/').match(/(Growduel\.onrender\.com\/battles\/[0-9a-fA-F]{24})/) !== null ||
                this.message.message.replace(/&#x2F;/g, '/').match(/(Growduel-stage\.onrender\.com\/battles\/[0-9a-fA-F]{24})/) !== null ||
                this.message.message.replace(/&#x2F;/g, '/').match(/(Growduel\.com\/duels\?game=[0-9a-fA-F]{24})$/) !== null
            ) {
                link = this.message.message.replace(/&#x2F;/g, '/').replace(/.*Growduel\.com/, '');
            }
            if (
                this.message.message.replace(/&#x2F;/g, '/').match(/(Growduel\.com\/battles\/[0-9a-fA-F]{24})/) !== null
            ...
            if (
                ...
                link = this.message.message.replace(/&#x2F;/g, '/').replace(/.*Growduel\.onrender\.com/, '');
            }
            if (
                this.message.message.replace(/&#x2F;/g, '/').match(/(Growduel-stage\.onrender\.com\/battles\/[0-9a-fA-F]{24})/) !== null
            ) {
                link = this.message.message.replace(/&#x2F;/g, '/').replace(/.*Growduel-stage\.onrender\.com/, '');
            }
