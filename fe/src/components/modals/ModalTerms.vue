<template>
    <div class="modal-terms">
        <div class="terms-header">
            ...
            <p>Welcome to Growduel! By using our website and services, you agree to be bound by the following terms and conditions (the "Terms of Service"). Please read them carefully.</p>
        </div>
        <div class="terms-list">
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>1.1 These Terms of Service constitute a legally binding agreement between you and Growduel
                    (the "Owner and Operator" of Growduel). By successfully registering an account on our website
                    ...
                    <p>1.3 Growduel is a virtual gaming website that offers fun and immersive games based on the virtual 
                    currency known as Robux. Growduel provides free-to-play opportunities on the site. To participate for 
                    free, you must register an account on Growduel. By doing so, you can join our rain feature, which 
                    ...
                    not allowed to transfer, attempt to transfer, or offer to transfer Robux won off Growduel for cash, 
                    cash equivalent, or any thing of value on a third-party platform.</p>
                    <p>b) Growduel will give you Robux FREE OF CHARGE on:
                        <ul>
                            <li>Rain Distribution - Rains occur on the site which spread Robux to all users who participate 
                            in them. To claim rains, you simply need to register an account on Growduel and complete KYC to 
                            collect them.</li>
                            <li>Promotional Giveaways - Promotional giveaways organized by Growduel on its social media accounts 
                            (Discord, Twitter, YouTube, Twitch, etc.).</li>
                        </ul>
                    </p>
                    <p>c) You may also win more Robux when you play games on Growduel, and you may purchase more Robux on Growduel 
                    to play.</p>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>4.1. Growduel is a free-to-play website. You can obtain free Growduel coins from various sources, 
                    including rain, promo codes, rewards, daily cases and giveaways. Growduel coins have no monetary value, 
                    and their purpose is solely for entertainment.</p>
                    <p>4.2. You can exchange your limiteds or Robux for Growduel coins or purchase Growduel coins directly 
                    ...
                    or purchase Growduel coins.</p>
                    <p>4.4. To ensure security and compliance, Growduel reserves the right to perform identity verification (KYC) 
                    when using cryptocurrencies, cards, or other payment methods to acquire Growduel coins. Failure to provide 
                    requested documents may result in account termination.</p>
                    <p>4.5. Growduel retains the right to adjust the coin rate.</p>
                    <p>4.6. We provide data on digital assets used for purchasing Growduel coins, but we make no representations 
                    regarding their value, quality, suitability, or accuracy. These assets are used for entertainment purposes.</p>
                    <p>4.7. Growduel coins are given out for free. Games like crash, mines, towers, and roll can be played with 0 
                    coins.</p>
                    <p>4.8. Users who acquire coins for free have the same winning odds as users who purchase Growduel coins.</p>
                </div>
            </div>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>5.1. Growduel strictly prohibits real-world trading. Sweepstakes prizes are non-transferable.</p>
                    <p>5.2. Growduel coins and limiteds hold no monetary value, are not private property, and cannot be sold, 
                    transferred, returned, or exchanged for real-world money or items of value.</p>
                    <p>5.3. You agree not to sell, transfer, or aid others in the exchange of Growduel coins or limiteds. Any 
                    attempt at real-world trading will result in account termination.</p>
                    <p>5.4. Growduel coins do not grant ownership rights, titles, or monetary value; they do not constitute real 
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>6.1. You can swap your Growduel tokens for limiteds or Robux using our marketplace feature.</p>
                    <p>6.2. Due to factors beyond Growduel's control, some withdrawals may experience delays. While most withdrawals 
                    ...
                    <p>6.3. After a user purchases Growduel tokens, they must wager an amount equal to their purchase before they can 
                    withdraw.</p>
                </div>
            </div>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>7.1 You can register and use only one account on Growduel.</p>
                    ...
                    to obtain access to Growduel, such as using a VPN service or other masking 
                    effort.</p>
                </div>
            </div>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>8.1 Growduel offers a rewards program called "rain". A base of 250 coins 
                    ...
                    join and receive a share of the rain's total pot. Rain is a reward for Growduel 
                    ...
                    termination of your account at Growduel's sole discretion.</p>
                    <p>8.2 Growduel also deploys another rewards program called "daily cases''. Daily 
                    cases are allowed to be opened by users once per day depending on their correlated 
                    level on Growduel. Growduel provides a daily case that is unlocked once per day to 
                    ...
                    the case once per day with the same odds as anyone else who uses the website. Growduel 
                    has the right to adjust the case contents and percentages of every daily case at its 
                    discretion.</p>
                    <p>8.3 Please note that the Rain feature listed on Growduel has guidelines set in place to 
                    prevent users from abusing it. We are unable to list every method a user is able to abuse the 
                    rain. If a user is caught abusing the rain while using Growduel as a free-to-play method, their 
                    access to our service will be immediately terminated.
                        <ul>
                            ...
                            to account termination across every account ever used on Growduel.</li>
                            ...
                            every account ever used on Growduel.</li>
                            ...
                            across every account ever used on Growduel.</li>
                            <li>Users depositing the minimum amount to claim rains every 2 week period without using the site as a 
                            free-to-play feature are subject to account termination across every account ever used on Growduel.</li>
                        </ul>
                    </p>
                    <p></p>
                    <p></p>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    <p>9.1 Growduel does not issue refunds on digital products once the order is confirmed and the product is sent. If 
                    you have any issues with receiving or downloading the product, please contact us at support@Growduel.live and we will 
                    assist you.</p>
                    <p>9.2 Refunds may be given at our discretion for technical issues determined by Growduel.</p>
                    ...
                    <p>9.4 If you make a purchase on Growduel that results in a chargeback, we may terminate your account. You agree that you 
                    must contact Growduel to seek a resolution of any issue before initiating a chargeback. We reserve the right to withhold any 
                    Robux generated from transactions that result in a chargeback.</p>
                    <p>9.5 You are responsible for any credit card chargebacks, dishonored checks, and any related fees that Growduel incurs with 
                    respect to your account, along with any additional fees or penalties imposed by our third-party billing agent.</p>
                    <p>9.6 Growduel utilizes third-party payment processors and gateways, and we reserve the right to contract with additional 
                    third-party payment processors and gateways in our sole discretion to process any and all payments associated with Growduel. 
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    ...
                    to comply with the legal process or as otherwise permitted by the privacy policy of Growduel (the Owner and Operator of Growduel).</p>
                    <p>13.2 Our privacy policy is available at https://www.Growduel.live/privacy.</p>
                </div>
            </div>
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    ...
                    <p>16.5 Growduel reserves the right to adjust your balance at its sole discretion. Growduel is in no way affiliated with the Ubisoft Entertainment or 
                    its trademarks.</p>
                </div>
            </div>
