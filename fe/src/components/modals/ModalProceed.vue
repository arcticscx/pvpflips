<template>
    <div class="modal-proceed">
        ...
        <div class="proceed-info">You will be directed to a third party provider that processes {{ modalsData.provider === 'skinify' ? 'steam item' : 'credit card' }} payments for Growduel. All the information you enter on their site is protected and encrypted.</div>
