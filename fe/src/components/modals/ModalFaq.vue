<template>
    <div class="modal-faq">
        ...
        <div class="faq-list">
            ...
            <FaqElement title="What is Growduel?" text="Growduel is a virtual arcade designed for Growtopia players to multiply their Robux or Limiteds! We are the most innovative arcade, and we strive to bring you the best experiences." />
            <FaqElement title="Why do you need my Growtopia credentials?" text="In order for us to automate our deposit and withdraw system, we utilize our P2P system to facilitate seamless transactions for depositors & withdrawers. Growduel ensures user security and we do not store your password. In any circumstances you feel unsafe with us having your credentials, you can simply invalidate them by changing your password on Growtopia.com." />
            ...
            <FaqElement title="I am missing coins, what now?" text="Please ensure you've not given access to your Growduel account or your Growtopia account. In the case you are compromised, we will assist you with regaining access to your account. Although, we do not issue balance adjustments to compensate for the loss, as your account security is your responsibility. If this involves a game issue, open a ticket in the discord." />
            ...
            <FaqElement title="How do I know that Growduel is fair & doesn't rig results?" text="Growduel is a provably fair casino. You can check all game results with our provably fair system, found at the bottom of our website." />
