<template>
    <div class="modal-privacy">
        <div class="privacy-header">
            ...
            <p>Growduel is committed to protecting the privacy of its users. This privacy policy applies to the
                Growduel website and services, and explains how we collect, use, and disclose information
            about you.</p>
        ...
        <div class="privacy-list">
            ...
            <div class="list-element">
                ...
                <div class="element-text">
                    ...
                    you newsletters, offers, and other updates about Growduel and our services. You may opt out of
