...
.home-banner-user {
    ...
    overflow: hidden;
    border-radius: 15px;
    border-bottom: 0.808px solid #984bf8;
    background: #161b23;
...
.home-banner-user .inner-auth.auth-blue .level-box::before {
    background: linear-gradient(180deg, rgba(6, 36, 61, 0) 0%, #984bf8 100%);
}
...
.home-banner-user .inner-auth.auth-blue .progress-bar {
    background: linear-gradient(90deg, #c49bff 0%, #984bf8 100%);
}
